...
from database.models import ContentMaterial, TypeContent, User
...
# 1) Список материалов — только для авторизованных
...
# 5) Просмотр одного материала — только авторизованные
...
# 6) Удаление — только авторизованные
